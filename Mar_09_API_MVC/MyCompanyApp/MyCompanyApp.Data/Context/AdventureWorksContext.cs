...
using MyCompanyApp.Data.Models;

namespace MyCompanyApp.Data.Context;
...
public partial class AdventureWorksContext : DbContext
{
    ...
    public virtual DbSet<SohPractice> SohPractices { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=MUKESH-SWAMI\\SQLEXPRESS01;Database=AdventureWorks2025;Trusted_Connection=True;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SohPractice>(entity =>
        {
            entity.HasIndex(e => e.SalesOrderId, "CX_SOH_Practice_SalesOrderID").IsClustered();
