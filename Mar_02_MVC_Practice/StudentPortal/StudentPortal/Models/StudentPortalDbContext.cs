...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=MUKESH-SWAMI\\SQLEXPRESS01;Database=StudentPortalDb;Trusted_Connection=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Course>(entity =>
        {
            entity.HasKey(e => e.CourseId).HasName("PK__Courses__C92D71A75E31EDFE");
        ...
        {
            entity.HasKey(e => e.EnrollmentId).HasName("PK__Enrollme__7F68771B0EE30C24");
        ...
        {
            entity.HasKey(e => e.StudentId).HasName("PK__Students__32C52B99EB69AD45");

            entity.HasIndex(e => e.Email, "UQ__Students__A9D10534747B098C").IsUnique();
        ...
        {
            entity.HasKey(e => e.LogId).HasName("PK__tblLog__5E548648E112AB31");
